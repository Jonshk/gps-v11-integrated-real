        ...
        <div style={{ position:"fixed", inset:0, background:"rgba(0,0,0,0.5)", backdropFilter:"blur(4px)", zIndex:100, display:"flex", alignItems:"center", justifyContent:"center", padding:20 }} onClick={close}>
          <div style={S.modal} onClick={e=>e.stopPropagation()}>
            ...
            <div style={{ ...S.field, background:"rgba(232,35,42,0.06)", border:"1px solid rgba(232,35,42,0.15)", borderRadius:10, padding:14 }}>
              ...
              <p style={{ color:"rgba(232,35,42,0.5)", fontSize:11, margin:"6px 0 0" }}>Recibe los comandos SMS.</p>
            </div>
            <div style={{ display:"grid", gridTemplateColumns:"1fr 1fr", gap:12, marginBottom:16 }}>
              ...
              <div><label style={S.label}>IMEI (opcional)</label><input style={S.input} value={form.imei||""} onChange={e=>set("imei",e.target.value)}/></div>
            </div>
