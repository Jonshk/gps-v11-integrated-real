...
const NAV = [
  ...
  },
  {
    ...
    label: "Vehículos",
    icon: "M5 17H3a2 2 0 01-2-2V5a2 2 0 012-2h11a2 2 0 012 2v3m-1 11a2 2 0 100-4 2 2 0 000 4zm-9 0a2 2 0 100-4 2 2 0 000 4zm10-7H9m4-4H9",
  },
  {
      ...
      >
        ...
        >
          {NAV.map((n) => {
            ...
            const isEmergency = n.href === "/admin/comandos";
            ...
            return (
              ...
              >
                ...
                {n.badge && (
                  <span style={{ fontSize: 12 }}>{n.badge}</span>
                )}
              </Link>
            );
          })}
