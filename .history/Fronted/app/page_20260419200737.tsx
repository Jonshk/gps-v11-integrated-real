...
const valueCards = [
  {
    ...
    stat: "100%", statLabel: "cobertura 24/7",
...
const plans = [
  {
    name: "Básico", price: "$9,99", period: "/mes USD",
    desc: "Para empezar a monitorear rápido.",
    items: ["Ubicación en tiempo real", "Historial de recorridos", "Acceso móvil", "Soporte básico"],
  },
  {
    name: "Pro", price: "$14,99", period: "/mes USD",
    desc: "El más solicitado por flotas medianas.",
    featured: true,
    items: ["Todo lo del Básico", "Geocercas ilimitadas", "Alertas avanzadas", "Soporte prioritario"],
  },
  {
    name: "Flotas", price: "A medida", period: "· cotizar",
    ...
    <main className="page-shell">
      ...
      <section id="solucion" className="section intro-strip">
        <div className="intro-copy">
          ...
          <h2>No es solo rastreo.<br />Es control operativo.</h2>
          <p>Visibilidad real sobre tu flota en Guayaquil y Ecuador. Respuesta rápida, menos pérdidas, operación que se ve seria.</p>
        </div>
      ...
      <section id="impacto" className="section cards-section">
        <div className="section-head">
          ...
          <h2>Resultados medibles desde el primer día.</h2>
        </div>
          ...
          {plans.map((plan) => (
            <article className={`price-card ${plan.featured ? "featured" : ""}`} key={plan.name}>
              ...
              <ul>
                {plan.items.map((item) => (
                  <li key={item}>
                    <svg viewBox="0 0 16 16" fill="none" aria-hidden="true"><path d="M3 8l3.5 3.5L13 4.5" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round"/></svg>
                    {item}
                  </li>
                ))}
              </ul>
      ...
      <section id="contacto" className="section final-cta">
        <div className="cta-box">
          ...
          <p>Escríbenos por WhatsApp y te guiamos con la mejor opción para carro, moto o flota en Ecuador.</p>
