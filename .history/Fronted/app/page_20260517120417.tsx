    ...
    <main className="page-shell">
      ...
      <section id="planes" className="section section-white">
        ...
        <div className="pricing-grid">
          {plans.map((plan) => (
            <article className={`price-card ${plan.featured ? "featured" : ""}`} key={plan.name}>
              ...
              {/* Nota debajo */}
              <p style={{
                marginTop: 10, fontSize: ".75rem", textAlign: "center",
        ...
        <div style={{
          ...
          <div>
            <strong style={{ fontSize: ".88rem", display: "block", marginBottom: 4 }}>
              ¿Como funciona el proceso?
            </strong>
            <p style={{ fontSize: ".82rem", color: "var(--muted)", lineHeight: 1.7, margin: 0 }}>
              Escríbenos por WhatsApp → acordamos la instalación → instalamos el GPS en tu vehículo
              → te enviamos las credenciales de la app → listo, tu flota está bajo control.
              Sin formularios, sin esperas, sin letra pequeña.
            </p>
          </div>
        </div>
      </section>
      ...
      <section id="contacto" className="section section-dark-cta">
        <div className="cta-inner">
          ...
          <div className="cta-actions">
            <a
              href={`https://wa.me/${PHONE}?text=${encodeURIComponent("Hola, quiero adquirir el servicio de GPS Control EC.")}`}
              target="_blank"
              rel="noreferrer"
            ...
            <a
              href={`https://wa.me/${PHONE}?text=${encodeURIComponent("Hola, quisiera una demo de GPS Control EC antes de decidirme.")}`}
              target="_blank"
              rel="noreferrer"
              className="cta-btn-ghost"
            >
              Solicitar demo primero
            </a>
