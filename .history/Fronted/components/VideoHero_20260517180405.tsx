  ...
  return (
    <section className="vh-section">
      ...
      <div className="vh-stats">
        <div className="vh-stat"><strong>+200</strong><span>empresas</span></div>
        <div className="vh-sep" />
        <div className="vh-stat"><strong>99.9%</strong><span>uptime</span></div>
        <div className="vh-sep" />
        <div className="vh-stat"><strong>10 min</strong><span>instalacion</span></div>
      </div>
